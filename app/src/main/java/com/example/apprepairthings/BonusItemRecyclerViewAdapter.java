...
public class BonusItemRecyclerViewAdapter extends RecyclerView.Adapter<BonusItemRecyclerViewAdapter.ViewHolder> {
    ...
    public BonusItemRecyclerViewAdapter() {
        mValues = new ArrayList<>();
        initAvatarColors();
    }

    public BonusItemRecyclerViewAdapter(List<RepairRequest> items) {
        mValues = items;
        initAvatarColors();
    }
    ...
    public void setItems(List<RepairRequest> items) {
        ...
        System.out.println("Bonus Adapter updated with " + items.size() + " items");
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_bonus_request, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        System.out.println("Bonus Binding: " + item.getName() + " | Status: " + item.getStatus());
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mAvatarView = view.findViewById(R.id.bonusAvatar);
            mNameView = view.findViewById(R.id.bonusName);
            mPhoneView = view.findViewById(R.id.bonusPhone);
            mDeviceView = view.findViewById(R.id.bonusDevice);
            mDateView = view.findViewById(R.id.bonusDate);
            mStatusView = view.findViewById(R.id.bonusStatus);
